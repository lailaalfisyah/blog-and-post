...
@section('container')
    ...
    <div class="col-md-6">
      <form action="/posts">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="input the keyword ..." name="search" value="{{ request('search') }}">
  ...
  @if ($posts->count())
    <div class="card mb-3">
      ...
      @else
        <img src="/img/{{ $posts[0]->category->slug }}.jpg" class="card-img-top" alt="{{ $posts[0]->category->slug }}">
      @endif
      ...
      <div class="row">
        @foreach ($posts->skip(1) as $post)
          <div class="col-md-4 mb-3">
            <div class="card">
              <div class="position-absolute bg-secondary px-3 py-2">
              ...
              @else
                <img src="/img/{{ $post->category->slug }}.jpg" class="card-img-top" alt="{{ $post->category->slug }}">
              @endif
